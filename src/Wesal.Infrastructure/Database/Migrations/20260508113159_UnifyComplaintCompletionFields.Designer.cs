...
namespace Wesal.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260508113159_UnifyComplaintCompletionFields")]
    partial class UnifyComplaintCompletionFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wesal.Domain.Entities.CourtStaffs.StaffWorkload", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CourtStaffId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CourtStaffId", "Type")
                        .IsUnique();

                    b.ToTable("StaffWorkload");
                });
            ...
            modelBuilder.Entity("Wesal.Domain.Entities.Custodies.Custody", b =>
                {
                    ...
                    b.Property<Guid>("CustodialParentId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Wesal.Domain.Entities.VisitationSchedules.VisitationSchedule", b =>
                {
                    ...
                    b.Property<string>("CustodialNationalId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Wesal.Domain.Entities.Complaints.Complaint", b =>
                {
                    b.HasOne("Wesal.Domain.Entities.CourtStaffs.CourtStaff", "AssignedStaff")
                        .WithMany()
            ...
            modelBuilder.Entity("Wesal.Domain.Entities.Custodies.Custody", b =>
                {
                    ...
                    b.HasOne("Wesal.Domain.Entities.Parents.Parent", null)
                        .WithMany()
                        .HasForeignKey("CustodialParentId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Wesal.Domain.Entities.Visitations.Visitation", b =>
                {
                    ...
                    b.HasOne("Wesal.Domain.Entities.VisitCenterStaffs.VisitCenterStaff", null)
                        .WithMany()
                        .HasForeignKey("VerifiedById")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Wesal.Domain.Entities.VisitationSchedules.VisitationSchedule", "VisitationSchedule")
                        .WithMany()
