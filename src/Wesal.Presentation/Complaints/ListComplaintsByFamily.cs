...
using Wesal.Application.Complaints.ListComplaintsByFamily;
...
internal sealed class ListComplaintsByFamily : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        ...
        .WithOpenApiName(nameof(ListComplaintsByFamily))
