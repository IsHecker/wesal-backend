...
internal sealed class SignInVisitCenterStaff : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapPost(ApiEndpoints.Auth.SignInVisitCenterStaff, async (
        ...
        .WithOpenApiName(nameof(SignInVisitCenterStaff))
        .AllowAnonymous();
    }
}