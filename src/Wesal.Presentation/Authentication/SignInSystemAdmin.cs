...
internal sealed class SignInSystemAdmin : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapPost(ApiEndpoints.Auth.SignInSystemAdmin, async (EmailPasswordRequest request, ISender sender) =>
        {
        ...
        .WithOpenApiName(nameof(SignInSystemAdmin))
        .AllowAnonymous();
    }
}