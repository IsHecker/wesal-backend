...
internal sealed class SignInFamilyCourt : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapPost(ApiEndpoints.Auth.SignInFamilyCourt, async (EmailPasswordRequest request, ISender sender) =>
        {
        ...
        .WithOpenApiName(nameof(SignInFamilyCourt))
        .AllowAnonymous();
    }
}